...
**Verification depth scales with `asvs_level`** (see @/home/nnex/dev/prj/copilot-metrics/.codex/gsd-core/references/security-asvs-levels.md for full definitions):
