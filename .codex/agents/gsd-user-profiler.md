...
<reference>
@/home/nnex/dev/prj/copilot-metrics/.codex/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/nnex/dev/prj/copilot-metrics/.codex/gsd-core/references/user-profiling.md` to load:
