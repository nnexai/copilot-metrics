...
Key references:
- @/home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/references/ui-brand.md (display patterns)
- @/home/nnex/dev/prj/copilot-metrics/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/USER-PROFILE.md" "/home/nnex/dev/prj/copilot-metrics/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/references/user-profiling.md`
...
Reference: @/home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/USER-PROFILE.md"
...
**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Your profile:    /home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/USER-PROFILE.md
```
