...
<template>
@/home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/workflows/transition.md`.
...
- Follow @/home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/workflows/diagnose-issues.md
