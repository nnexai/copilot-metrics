...
```bash
INIT=$(node "/home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/templates/spec.md.
