...
- Usage: Reference from command with `@/home/nnex/dev/prj/copilot-metrics/.codex/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/nnex/dev/prj/copilot-metrics/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/nnex/dev/prj/copilot-metrics/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
