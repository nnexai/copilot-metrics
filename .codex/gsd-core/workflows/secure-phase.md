...
```
Agent(
  prompt="Read /home/nnex/dev/prj/copilot-metrics/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/nnex/dev/prj/copilot-metrics/.codex/gsd-core/templates/SECURITY.md`
