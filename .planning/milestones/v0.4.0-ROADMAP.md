...
- [x] **Phase 12: v0.4.0 setup labelPattern init** - Let users set internal extractor label patterns during setup/init without hand-editing config. (completed 2026-06-03)
- [x] **Phase 13: v0.4.0 label association confidence model** - Preserve all label associations and compute deterministic per-session label confidence rankings. (completed 2026-06-03)
- [x] **Phase 14: v0.4.0 confidence-aware label reports** - Make label reports use top-confidence semantics by default and add a per-session middle-detail view. (completed 2026-06-03)
